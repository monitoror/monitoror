...
type (
	MonitorableRouter interface {
		RouterGroup(path string, variant coreModels.VariantName) MonitorableRouterGroup
	}
...
func (r *router) RouterGroup(path string, variant coreModels.VariantName) MonitorableRouterGroup {
